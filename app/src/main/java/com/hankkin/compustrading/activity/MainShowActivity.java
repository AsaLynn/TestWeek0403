...
public class MainShowActivity extends BaseActivity {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    for (int i = 0; i < categories.size(); i++) {
                        ...
                        LogUtils.i("cid:" + categories.get(i).getId());
    ...
    private void init() {
        ...
        if (person != null) {
            ...
            rvUser.setBackgroundDrawable(getResources().getDrawable(R.drawable.defaut));
    ...
    private void toGson(List<Product> data) {
